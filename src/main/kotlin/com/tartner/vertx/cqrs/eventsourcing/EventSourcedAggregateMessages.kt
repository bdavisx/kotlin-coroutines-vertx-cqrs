...
/**
 This should only be fired upon a new load of the aggregte. Will return
...
data class AggregateInvalidatedEvent(val aggregateId: AggregateId)
  : EventSourcedAggregateMessages(), DomainEvent
...
data class AttemptToInitializeAlreadyInitializedAggregateEvent(override val aggregateId: UUID,
  val command: DomainCommand): EventSourcedAggregateMessages(),
  ErrorEvent, HasAggregateId
